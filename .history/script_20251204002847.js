...
numberIncrement.addEventListener('click', () => {
    let incrementColor = numberIncrement.style.backgroundColor = 'chocolate';
    ...
    if (counting > 0) {
        startCount.style.color = '#C6AC8F';
    }
    else if (counting === 0) {
        startCount.style.color = '#5e503f';
    }
    if (numberCount < 0) {
        startCount.style.color = 'maroon'
    }
...
numberDecrement.addEventListener('click', () => {
    let decrementColor = numberDecrement.style.backgroundColor = 'brown';
...
numberReset.addEventListener('click', () => {
    let resetColor = numberReset.style.backgroundColor = '';

    //Reset the other button colours
    numberIncrement.style.backgroundColor = '';
    numberDecrement.style.backgroundColor = '';
